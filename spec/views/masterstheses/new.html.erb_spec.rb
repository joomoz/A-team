...
RSpec.describe "masterstheses/new", type: :view do
  before(:each) do
    assign(:mastersthesis, Mastersthesis.new(
      :key => "MyString",
      :author => "MyText",
      :title => "MyText",
      :journal => "MyText",
  ...
  it "renders new mastersthesis form" do
    render

    assert_select "form[action=?][method=?]", masterstheses_path, "post" do
