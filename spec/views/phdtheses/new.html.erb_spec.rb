...
RSpec.describe "phdtheses/new", type: :view do
  before(:each) do
    assign(:phdthesis, Phdthesis.new(
      :key => "MyString",
      :author => "MyText",
      :title => "MyText",
      :journal => "MyText",
  ...
  it "renders new phdthesis form" do
    render

    assert_select "form[action=?][method=?]", phdtheses_path, "post" do
