...
RSpec.describe "booklets/new", type: :view do
  before(:each) do
    assign(:booklet, Booklet.new(
      :key => "MyString",
      :author => "MyText",
      :title => "MyText",
      :journal => "MyText",
  ...
  it "renders new booklet form" do
    render

    assert_select "form[action=?][method=?]", booklets_path, "post" do
