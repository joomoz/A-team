...
RSpec.describe "techreports/new", type: :view do
  before(:each) do
    assign(:techreport, Techreport.new(
      :key => "MyString",
      :author => "MyText",
      :title => "MyText",
      :journal => "MyText",
  ...
  it "renders new techreport form" do
    render

    assert_select "form[action=?][method=?]", techreports_path, "post" do
